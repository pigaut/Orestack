...
public class EnhancedPlayerDataManager<T extends EnhancedPlayerData> extends Manager {
    ...
    public EnhancedPlayerDataManager(@NotNull EnhancedJavaPlugin plugin, @NotNull PlayerDataFactory<T> playerDataFactory) {
        super(plugin);
