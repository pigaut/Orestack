...
public class GateUtil {
    ...
    public static void open(@NotNull Gate gate) {
        ...
        io.github.pigaut.rpg.api.event.gate.GateOpenEvent gateOpenEvent = new io.github.pigaut.rpg.api.event.gate.GateOpenEvent(origin, gate.getName(), gate.getState().getCurrentPhase());
    ...
    public static void close(@NotNull Gate gate) {
        ...
        io.github.pigaut.rpg.api.event.gate.GateCloseEvent gateCloseEvent = new GateCloseEvent(origin, gate.getName(), gate.getState().getCurrentPhase());
