...
public class SkillConditions {
    ...
    public static void registerAll(@NotNull EnhancedPlugin plugin) {
        ...
        conditions.register("HAS_SKILL_LEVEL", (ConfigLoader.Line<Condition>) line ->
                new PlayerSkillLevelEquals(line.getRequired(1, Amount.class),
                        line.getRequired("skill", SkillTemplate.class)));

        conditions.register("SKILL_NAME_EQUALS", (ConfigLoader.Line<Condition>) line ->
                new SkillNameEquals(line.getRequiredString(1)));

        conditions.register("SKILL_HAS_REWARDS", (ConfigLoader.Line<Condition>) line ->
                new SkillHasRewards());

        conditions.register("SKILL_LEVEL_EQUALS", (ConfigLoader.Line<Condition>) line ->
                new SkillLevelEquals(line.getRequired(1, Amount.class)));

        conditions.register("SKILL_LEVEL_IS_LOCKED", (ConfigLoader.Line<Condition>) line ->
                new SkillLevelEquals(Amount.lessThan(line.getRequiredInteger(1))));

        conditions.register("SKILL_LEVEL_IS_IN_PROGRESS", (ConfigLoader.Line<Condition>) line ->
                new SkillLevelEquals(Amount.fixed(line.getRequiredInteger(1) - 1)));

        conditions.register("SKILL_LEVEL_IS_COMPLETED", (ConfigLoader.Line<Condition>) line ->
                new SkillLevelEquals(Amount.greaterThanOrEqual(line.getRequiredInteger(1))));

        conditions.register("SKILL_MAX_LEVEL_EQUALS", (ConfigLoader.Line<Condition>) line ->
                new SkillMaxLevelEquals(line.getRequired(1, Amount.class)));

        conditions.register("SKILL_HAS_LEVEL", (ConfigLoader.Line<Condition>) line ->
