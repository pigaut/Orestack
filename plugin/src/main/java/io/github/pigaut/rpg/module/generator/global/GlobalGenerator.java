package io.github.pigaut.rpg.module.generator.global;
...
public class GlobalGenerator extends BasicGenerator {
    ...
    public static @NotNull GlobalGenerator create(@NotNull GeneratorTemplate template, @NotNull Location origin,
                                                  @NotNull Rotation rotation, int phase) throws GeneratorCreateException {
    ...
    public static @NotNull GlobalGenerator create(@NotNull GeneratorTemplate template,
                                                  @NotNull Location origin, @NotNull Rotation rotation) throws GeneratorCreateException {
        return create(template, origin, rotation, template.getMaxPhase());
    }

    public static @NotNull GlobalGenerator create(@NotNull GeneratorTemplate template, @NotNull Location origin) throws GeneratorCreateException {
