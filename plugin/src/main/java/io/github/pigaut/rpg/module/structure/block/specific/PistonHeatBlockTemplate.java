...
public class PistonHeatBlockTemplate extends AbstractBlockTemplate<PistonHead> {

    private final BlockFace facing;
    private final boolean shortHead;

    public PistonHeatBlockTemplate(@NotNull Material type, BlockFace facing, boolean shortHead) {
