...
public class EnhancedPlayerStateManager<T extends PlayerState> extends Manager {
    ...
    public EnhancedPlayerStateManager(@NotNull EnhancedJavaPlugin plugin, @NotNull PlayerStateFactory<T> playerStateFactory) {
        super(plugin);
