...
public class IntegerYieldFunction implements YieldFunction<Integer> {

    private final Function function;

    public IntegerYieldFunction(@NotNull Function function) {
    ...
    @Override
    public Integer yield(@NotNull Context context) {
