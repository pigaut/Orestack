...
public class StatGiveManaSubCommand extends SubCommand {

    public StatGiveManaSubCommand(@NotNull EnhancedPlugin plugin) {
        super(plugin, "give-mana");
        withPermission(plugin.getPermission("stat.give-mana"));
        withDescription(plugin.getTranslation("stat-give-mana-command"));
        ...
        withCommandExecution((sender, context, args) -> {
            ...
            plugin.sendMessage(sender, context, "gave-mana");
        });
    }
