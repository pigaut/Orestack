...
//    int getGeneratorMaxPhase(@NotNull Location location);
     ...
     */
    void openGate(@NotNull Location location);
     ...
     * @throws IllegalArgumentException if the location is not a gate
     */
    void closeGate(@NotNull Location location);
     ...
     * @throws IllegalArgumentException if the location is not a gate
     */
    void damageGate(@NotNull Location location, @NotNull Player player, int amount) throws IllegalArgumentException;
